...
public class Pit {
    ...
    public Pit(@NotNull Integer pitIndex, @NotNull Integer stoneCount, @NotNull Integer playerIndex) {
        this.pitIndex = pitIndex;
        this.stoneCount = stoneCount;
        this.playerIndex = playerIndex;
    }

    public @NotNull Integer getPitIndex() {
        return pitIndex;
    }

    public void setPitIndex(@NotNull Integer pitIndex) {
        this.pitIndex = pitIndex;
    }

    public @NotNull Integer getStoneCount() {
        return stoneCount;
    }

    public void setStoneCount(@NotNull Integer stoneCount) {
        this.stoneCount = stoneCount;
    }

    public @NotNull Integer getPlayerIndex() {
        return playerIndex;
    }

    public void setPlayerIndex(@NotNull Integer playerIndex) {
        this.playerIndex = playerIndex;
    }
